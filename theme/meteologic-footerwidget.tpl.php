...
/**
 * @file
 * Default module implementation to display the meteologic_footerwidget block.
 *
 * Available variables:
 ...
 * @see meteologic.module :: meteologic_prerender_footerwidget()
 * @see theme/meteologic.theme.inc :: meteologic_preprocess_meteologic_footerwidget()
 * 
 * @ingroup themeable
 * 
 * CUSTOMISIBLE THEME IMPLEMENTATION
 * copy this file to your theme folder
 * add meteologic_preprocess_meteologic_footerwidget(&$vars){}
 * to your themes template.php where you can set/modified data from supplied feeds
 * 
 */

if($current) {
  drupal_print_message($current);
}

if($forecast) {
  drupal_prin($forecast);
}
